      ...
      success: function (response) {
        ...
        $.each(response, function (index, item) {
          $('.cards').append(
            ...
            '<div class="card-action">' + '<img class="favicon" src="' + 'http://www.google.com/s2/favicons?domain=' + item.site_name + '">' + '<span class="resource-site_name">' + item.site_name + '</span><a href="' + item.url + '" class="resource-original" target="_blank">Original<i class="material-icons right">open_in_new</i></a></div></div></div>'
          )
        })
      }, // end success action
